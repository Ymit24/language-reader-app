...
1. VocabScreen scaffold - Basic layout with responsive split-view
1. LanguageTabs - Language switching
1. VocabFilters - Search, status filters, sort
1. VocabList + VocabRow - Paginated list with selection
1. VocabDetailPanel - Word details and editing
1. BulkActionBar - Multi-select actions
1. Polish - Loading states, animations, edge cases
